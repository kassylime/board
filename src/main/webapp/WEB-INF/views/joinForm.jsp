    ...
    <section>
        <div class="content">
            <form action="joinProc" method="post" class="login-form" name="jForm" onsubmit="return check()">
                ...
                <input type="password" class="login-input" name="m_pwd" title="비밀번호" placeholder="비밀번호 입력">
                <input type="text" class="login-input" name="m_name" title="이름" placeholder="이름 입력">
                <input type="text" class="login-input" name="m_birth" title="생일" placeholder="생일 입력">
                <input type="text" class="login-input" name="m_addr" title="주소" placeholder="주소 입력">
                <input type="text" class="login-input" name="m_phone" title="연락처" placeholder="연락처 입력">
...
<script>
    ...
    // 중복확인이 되었고, 모든 입력이 된 다음에 전송하도록 하는 함수
    // check() + onsubmit 속성
    function check(){
        // 아이디 중복 확인이 되었는가?
        if(ck == false){
