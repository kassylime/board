...
public class BoardController {
    ...
    @GetMapping("list")
    public ModelAndView boardList(SearchDto search, HttpSession session){
        log.info("boardList()");
        mv = bServ.getBoradList(search, session);
    ...
    public String updateProc(@RequestPart List<MultipartFile> files, BoardDto board, HttpSession session, RedirectAttributes rttr){
        log.info("updateProc()");
